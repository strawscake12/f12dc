...
from RianAPI.linepy import *
from RianAPI.akad.ttypes import Message
from RianAPI.akad.ttypes import ContentType as Type
from RianAPI.akad.ttypes import ChatRoomAnnouncementContents
...
client = LINE("EtVaijXHfQ9GU6VEEtfe.E8ph3c+s79R9Ar99OXG9NG.Kg0MmxLrxMu6qYOEZjNEsCYGgf6OVPu3pVB0EWB8Suc=")
#client = LINE("")
...
def sendLineMusic(to):
    ...
    return client.sendMessage(to, 'Rian~', contentMetadata, 19)
...
def helpmyself():
    ...
    helpMySelf =    "╔══[ Self Command ]" + "\n" + \
                    ...
                    "╠ " + key + "MyVideoProfile" + "\n" + \
                    "╠ " + key + "MyCover" + "\n" + \
                    "╠ " + key + "CuriContact「Tag Orgnya>_<」" + "\n" + \
                    "╠ " + key + "CurilMid「Tag Orgnya>_<」" + "\n" + \
                    "╠ " + key + "CuriName「Tag Orgnya>_<」" + "\n" + \
                    "╠ " + key + "CuriBio「Tag Orgnya>_<」" + "\n" + \
                    "╠ " + key + "CuriPicture「Tag Orgnya>_<」" + "\n" + \
                    "╠ " + key + "CuriVideoProfil「Tag Orgnya>_<」" + "\n" + \
...
def helpgroup():
    ...
    helpGroup =     "╔══[ Group Command ]" + "\n" + \
                    ...
                    "╠ " + key + "CGP" + "\n" + \
                    "╠ " + key + "Tagall" + "\n" + \
                    "╠ " + key + "Mimicadd Tag Orgnya" + "\n" + \
                    "╠ " + key + "Mimicdel Tag Orgnya" + "\n" + \
                    "╠ " + key + "MimicList" + "\n" + \
                    "╚══[ ᵀᴱᴬᴹ ᶜᴴᴵᴸᴰ ᴮᴼᵀ ]"
...
def clientBot(op):
    try:
        ...
        if op.type == 5:
            ...
            sendMention(op.param1, "Hayo @!,Stalker Akun Saya Yah", [op.param1])
        ...
        if op.type == 13:
            ...
            if clientMid in op.param3:
                ...
                sendMention(op.param1, "Halo @!, Terimakasih Telah Mengundang Saya :3", [op.param1])
                ...
                if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            if cmd == "help":
                                name = "        「 Creator >_< 」      "
                                link = "http://line.me/ti/p/i44REUJODK"
                                icon = "http://dl.profile.line-cdn.net/0hp3PAqOGPLxxtOAJbRzZQS1F9IXEaFilUFVgzKEpqd3kSCz8fUgo3LxhvJCtICD9MBA5iekE6JCQU"
                                ...
                                name = "            「 Media >_< 」   "
                                link = "http://line.me/ti/p/i44REUJODK"
                                icon = "https://i.pinimg.com/564x/7b/20/ed/7b20ed369ddd14af24f7b5b01f8457f8--masamune-makabe-masamune-kun-no-revenge.jpg"
                                ...
                                start = time.time()
                                client.sendMessage(to, "Tunggu Njink...")
                                elapsed_time = time.time() - start
                                client.sendMessage(to, "[ Speed ]\n{} Second".format(str(elapsed_time)), {'AGENT_NAME': '「 Speed 」 >_<', 'AGENT_LINK': 'https://line.me/ti/p/IpWxNL4Lbz','AGENT_ICON': "http://dl.profile.line-cdn.net/0hp3PAHv4JLxxtOAJg1wtQS1F9IXEaFilUFVgzKEpqd3kSCz8fUgo3LxhvJCtICD9MBA5iekE6JCQU"})
                            elif cmd == "runtime":
                                timeNow = time.time()
                                runtime = timeNow - botStart
                                runtime = format_timespan(runtime)
                                client.sendMessage(to, "Bot Sudah Berjalan Selama "+str(runtime), {'AGENT_NAME': '「 RunTime 」 >_<', 'AGENT_LINK': 'https://line.me/ti/p/IpWxNL4Lbz','AGENT_ICON': "http://dl.profile.line-cdn.net/0hp3PAHv4JLxxtOAJg1wtQS1F9IXEaFilUFVgzKEpqd3kSCz8fUgo3LxhvJCtICD9MBA5iekE6JCQU"})
                            elif cmd == "restart":
...
# Pembatas Script #
       ...
       #                               CLOSE                                     #
                            ...
                            elif cmd.startswith("curivideoprofil "):
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    names = re.findall(r'@(\w+)', text)
                                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                                    mentionees = mention['MENTIONEES']
...
# Pembatas Script #
                              ...
                              client.sendMessage(to, "[ Error Log ]\nBerhasil Mereset Log Error")
                                ...
                                groups = client.groups
                                for group in yan:
                                    client.sendMessage(group, "[ BroadCast ]\n"+txt, {'AGENT_NAME': '「 Broadcasted 」 >_<', 'AGENT_LINK': 'http://line.me/ti/p/i44REUJODK','AGENT_ICON': "http://dl.profile.line-cdn.net/0hp3PAqOGPLxxtOAJbRzZQS1F9IXEaFilUFVgzKEpqd3kSCz8fUgo3LxhvJCtICD9MBA5iekE6JCQU"})
                                client.sendMessage(to, "Berhasil broadcast ke {} group".format(str(len(groups))))
                            elif cmd == "cvp":
                                 pict = client.downloadFileURL("http://dl.profile.line-cdn.net/0hp3PAqOGPLxxtOAJbRzZQS1F9IXEaFilUFVgzKEpqd3kSCz8fUgo3LxhvJCtICD9MBA5iekE6JCQU")
                                ...
                                pict = client.downloadFileURL("http://dl.profile.line-cdn.net/0hnatx2tuMMU5JARw3PshOGXVEPyM-LzcGMTcpIG5UZi4wNXdMdmN5emVUOnhkNnMddDB2IGsIPXgx")
                                vids = client.downloadFileURL("https://r2---sn-uigxxi0ujipnvo-hxne.googlevideo.com/videoplayback?ipbits=0&c=WEB&id=o-AKmRCsLqcgOWco3cilZyMP4qBFf0x8RjzId-7rh4-M7x&key=cms1&ip=144.76.174.116&mime=video%2Fmp4&pl=24&source=youtube&dur=25.100&expire=1528804256&signature=01D01F8CA665A791D1D6A3116EEB12D7035A41E2.251070E8174CB983DECD4761F3D802BAB0EEC971&ratebypass=yes&lmt=1524883842177566&fvip=2&sparams=dur,ei,expire,id,initcwndbps,ip,ipbits,itag,lmt,mime,mip,mm,mn,ms,mv,pl,ratebypass,requiressl,source&requiressl=yes&ei=QF8fW4H4HpXygAeJ8rnYBw&itag=22&title=[Menhera-Chan]%20-%20%20All%20Falls%20Down&cms_redirect=yes&mip=116.206.30.49&mm=31&mn=sn-uigxxi0ujipnvo-hxne&ms=au&mt=1528782531&mv=m")
                                changeVideoAndPictureProfile(pict, vids)
                                ...
                                c.displayFields = 5
                                c.text = a
                                c.link = "line://ti/p/~goblokk."
                                c.thumbnail = "http://dl.profile.line-cdn.net/0hp3PAqOGPLxxtOAJbRzZQS1F9IXEaFilUFVgzKEpqd3kSCz8fUgo3LxhvJCtICD9MBA5iekE6JCQU"
                                try:
                                ...
                                try:
                                    arr = []
                                    saya ="u7bc3c7dc2fd2efdafd691f7da3183d9e"
                                    ...
                                    ret_ += "\n╠Creator: Rian"
                                    ret_ += "\n╠Self Bot By Rian"
                                    ret_ += "\n╚══[ Contact Me : http://line.me/ti/p/i44REUJODK ]"
                                    client.sendMessage(to, str(ret_))
                                    sendLineMusic(to)
                                except Exception as e:
                                    client.sendMessage(msg.to, str(e))
...
# Pembatas Script #
                        ...
                        client.getGroup(receiver)]:
                            ...
                            link = "https://line.me/ti/p/IpWxNL4Lbz"
                            icon = "https://i.pinimg.com/564x/7b/20/ed/7b20ed369ddd14af24f7b5b01f8457f8--masamune-makabe-masamune-kun-no-revenge.jpg"
                            name = "「 You Ticket>_< 」"
