...
client = LINE("Et3NV6JOiLN7WBx97Y7e.E8ph3c+s79R9Ar99OXG9NG.mlU7CWuROYr6H/KJUagYpZOjN+g8zRdAqXcSMRuTGDw=")
#client = LINE("")
...
# Pembatas Script #
                              ...
                              client.sendMessage(to, "[ Error Log ]\nBerhasil Mereset Log Error")
                                ...
                                groups = client.groups
                                for group in yan:
                                    client.sendMessage(group, "[ BroadCast ]\n"+txt, {'AGENT_NAME': '「 Broadcasted 」 >_<', 'AGENT_LINK': 'https://line.me/ti/p/IpWxNL4Lbz','AGENT_ICON': "http://dl.profile.line-cdn.net/0hp3PA1zFVLxxtOAJns49QS1F9IXEaFilUFVgzKEpqd3kSCz8fUgo3LxhvJCtICD9MBA5iekE6JCQU"})
                                client.sendMessage(to, "Berhasil broadcast ke {} group".format(str(len(groups))))
                            elif cmd == "cvp":
                                 pict = client.downloadFileURL("https://i.pinimg.com/564x/4a/7d/82/4a7d829b0f198756cbdec63559c42447.jpg")
                                 vids = client.downloadFileURL("https://sv17.onlinevideoconverter.com/download?file=b1g6a0g6i8g6h7c2")
                                 changeVideoAndPictureProfile(pict, vids)
                                 client.sendMessage(to, "[ Succes Njink ]", {'AGENT_NAME': '「 ChangeDual Mamank 」 >_<', 'AGENT_LINK': 'https://line.me/ti/p/IpWxNL4Lbz','AGENT_ICON': "http://dl.profile.line-cdn.net/0hp3PAtVVLLxxtOAJnb0BQS1F9IXEaFilUFVgzKEpqd3kSCz8fUgo3LxhvJCtICD9MBA5iekE6JCQU"})
                            elif cmd == "cvp1":
                                pict = client.downloadFileURL("https://i.pinimg.com/564x/57/82/26/578226359c7ae52a89f9f35c3fbc846b.jpg")
                                vids = client.downloadFileURL("https://r2---sn-uigxxi0ujipnvo-hxne.googlevideo.com/videoplayback?requiressl=yes&ip=46.4.85.237&key=cms1&mime=video%2Fmp4&sparams=dur,ei,expire,id,initcwndbps,ip,ipbits,itag,lmt,mime,mip,mm,mn,ms,mv,pl,ratebypass,requiressl,source&itag=22&pl=24&id=o-AA-KxKadXUysAP48Sm9m8Ie10sCGLKJ6D1zPAvZ3LYoJ&signature=01337D723D866607D51DA61F298B34993C7E5F5D.2810638A7FB9C5CFF15E6C5AC97ACB5138CD0C8A&lmt=1524883842177566&source=youtube&fvip=6&dur=25.100&ipbits=0&ei=e5gcW9HQOYHdgAf8yL74Cg&expire=1528622300&c=WEB&ratebypass=yes&title=[Menhera-Chan]%20-%20%20All%20Falls%20Down&cms_redirect=yes&mip=116.206.38.53&mm=31&mn=sn-uigxxi0ujipnvo-hxne&ms=au&mt=1528600609&mv=m")
                                changeVideoAndPictureProfile(pict, vids)
                                ...
                                c.thumbnail = "http://dl.profile.line-cdn.net/0hp3PA1zFVLxxtOAJns49QS1F9IXEaFilUFVgzKEpqd3kSCz8fUgo3LxhvJCtICD9MBA5iekE6JCQU"
                                try:
                                ...
                                try:
                                    ...
                                    ret_ = "「 About Bot >_< 」"
                                    ret_ += "\n「 Thanks For HelloWorld >_< 」"
                                    ret_ += "\n「 This SelfBot Premium >_< 」"
                                    ret_ += "\n「 Creator: Rian "
                                    ret_ += "\n「 Self Bot By Rian >_< 」"
                                    client.sendMessage(to, str(ret_))
                                except Exception as e:
                                ...
                                vids = client.downloadFileURL("https://sv32.onlinevideoconverter.com/download?file=b1f5j9h7a0g6d3d3")
                                changeVideoAndPictureProfile(pict, vids)
